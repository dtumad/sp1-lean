...
private theorem subcols_interactions_faithful_syntactic
  ...
  refine List.Perm.trans ?_ (Extracted.perm_filter_by_kind_of_no_raw _
      (by simp [ChipOracle.nativeInteractions, subChipOracle, Extracted.Interaction.IsRaw,
        Extracted.CPUState.interactions, Extracted.RTypeReader.interactions,
        Extracted.SubOracle.SubCols.interactions, Extracted.SubOracle.SubOperation.interactions])).symm
