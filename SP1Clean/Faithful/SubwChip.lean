...
private theorem subwcols_interactions_faithful_syntactic
  ...
  refine List.Perm.trans ?_ (Extracted.perm_filter_by_kind_of_no_raw _
      (by simp [ChipOracle.nativeInteractions, subwChipOracle, Extracted.Interaction.IsRaw,
        Extracted.CPUState.interactions, Extracted.RTypeReader.interactions,
        Extracted.SubwOracle.SubwCols.interactions,
        Extracted.SubwOracle.SubwOperation.interactions,
        Extracted.SubwOracle.U16MSBOperation.interactions])).symm
