...
private theorem addcols_interactions_faithful_syntactic
  ...
  refine List.Perm.trans ?_ (Extracted.perm_filter_by_kind_of_no_raw _
      (by simp [ChipOracle.nativeInteractions, addChipOracle, Extracted.Interaction.IsRaw,
        Extracted.AddOracle.AddCols.interactions, Extracted.AddOracle.AddOperation.interactions,
        Extracted.CPUState.interactions, Extracted.RTypeReader.interactions])).symm
