...
private theorem addwcols_interactions_faithful_syntactic
  ...
  refine List.Perm.trans ?_ (Extracted.perm_filter_by_kind_of_no_raw _
      (by simp [ChipOracle.nativeInteractions, addwChipOracle, Extracted.Interaction.IsRaw,
        Extracted.ALUTypeReader.interactions, Extracted.AddwOracle.AddwCols.interactions,
        Extracted.AddwOracle.AddwOperation.interactions,
        Extracted.AddwOracle.U16MSBOperation.interactions, Extracted.CPUState.interactions])).symm
...
private theorem addwOperationAssertions
  ...
  rw [ha0, ha1, hb0, hb1, hv0, hv1, hmsb, hr]
  simp
