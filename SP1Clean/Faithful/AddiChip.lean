...
private theorem addicols_interactions_faithful_syntactic
  ...
  refine List.Perm.trans ?_ (Extracted.perm_filter_by_kind_of_no_raw _
      (by simp [ChipOracle.nativeInteractions, addiChipOracle, Extracted.Interaction.IsRaw,
        Extracted.AddiOracle.AddOperation.interactions,
        Extracted.AddiOracle.AddiCols.interactions, Extracted.CPUState.interactions,
        Extracted.ITypeReader.interactions])).symm
  rw [hState, hProgram']
