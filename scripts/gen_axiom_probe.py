...
EXACT_REQUIRED_THEOREMS = [
    ...
    ("Machine/Core/Path.lean", "append_iff"),
    ("Machine/Core/Path.lean", "Segment.iff_reachableIn"),
    ("Machine/Core/Reachable.lean", "ReachableIn.add"),
    ("Machine/Core/Reachable.lean", "ReachableIn.split"),
    ...
    ("SP1Clean/FormalModel/ShardMachine.lean", "executionSegment_iff_segment"),
