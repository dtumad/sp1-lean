...
EXACT_REQUIRED_THEOREMS = [
    ...
    ("SP1Clean/Model/Core/MemoryFinalCheck.lean", "changes_nodup"),
    ("SP1Clean/Model/Core/MemoryFinalCheck.lean", "checkFinal_iff_changes"),
    ("SP1Clean/Model/FinalMemoryValue.lean", "channel"),
    ("SP1Clean/Model/FinalMemoryValue.lean", "guarantees"),
    ("SP1Clean/FormalModel/Contracts/FinalRegisterValue.lean", "Spec"),
    ("SP1Clean/FormalModel/Contracts/FinalRamValue.lean", "Spec"),
    ("SP1Clean/FormalModel/Contracts/FinalRamValue.lean", "Spec.snapshot"),
    ("SP1Clean/Native/Operations/FinalRegisterValue.lean", "circuit"),
    ("SP1Clean/Native/Operations/FinalRegisterValue.lean", "populate?"),
    ("SP1Clean/Native/Operations/FinalRegisterValue.lean", "populate?_isSome_iff"),
    ("SP1Clean/Native/Operations/FinalRegisterValue.lean", "populate?_sound"),
    ("SP1Clean/Native/Operations/FinalRegisterValue.lean", "receipt_values"),
    ("SP1Clean/Native/Operations/FinalRamValue.lean", "circuit"),
    ("SP1Clean/Native/Operations/FinalRamValue.lean", "populate?"),
    ("SP1Clean/Native/Operations/FinalRamValue.lean", "populate?_isSome_iff"),
    ("SP1Clean/Native/Operations/FinalRamValue.lean", "populate?_sound"),
    ("SP1Clean/Native/Operations/FinalRamValue.lean", "receipt_values"),
    ("SP1Clean/Native/Operations/FinalMemoryReceipt.lean", "circuit"),
    ("SP1Clean/Native/Operations/FinalMemoryReceipt.lean", "width"),
    ("SP1Clean/Native/Operations/FinalMemoryReceipt.lean", "constraints"),
    ("SP1Clean/Native/Operations/FinalMemoryReceipt.lean", "lookups"),
    ("SP1Clean/Native/Operations/FinalMemoryReceipt.lean", "receipt_interactions"),
    ("SP1Clean/Native/Operations/FinalMemoryReceipt.lean", "interactions"),
    ("SP1Clean/Native/Operations/InitialMemoryLookup.lean", "circuitNamed"),
    ("SP1Clean/Native/Operations/InitialMemoryRead.lean", "circuitNamed"),
    ("SP1Clean/Native/Operations/InitialMemoryRead.lean", "ProverAssumptions.spec"),
    ("SP1Clean/Native/Operations/InitialMemoryRead.lean", "eval_base"),
    ("SP1Clean/Native/Operations/InitialMemoryRead.lean", "eval_result"),
    ("SP1CleanTest/Core/FinalMemoryValue.lean", "constructedRows"),
    ("SP1CleanTest/Core/FinalMemoryValue.lean", "rejectsForgedValues"),
    ("SP1CleanTest/Core/FinalMemoryValue.lean", "receiptAccounting"),
    ("SP1CleanTest/Core/MemoryFinalCheck.lean", "completeChanges"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "terminalIdentity"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "installedHaltExit"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsInstalledExitForgery"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsSuppliedExitStatus"),
    ...
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "hostBookkeeping"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "bookkeepingObservationExamples"),
    ...
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "ordinaryBookkeeping"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "untouchedCommitMemory"),
    ...
    ("ToPolyFun/Dynamical/Orbit.lean", "ReachableIn.add"),
    ("ToPolyFun/Dynamical/Orbit.lean", "ReachableIn.split"),
    ("ToPolyFun/Dynamical/Labeled.lean", "Trace.append"),
    ("ToPolyFun/Dynamical/Labeled.lean", "Trace.reachableIn"),
    ("ToClean/Air/Realizes.lean", "statement_iff"),
    ("ToClean/Air/Realizes.lean", "reachable_of_statement"),
    ("SP1Clean/FormalModel/ShardMachine.lean", "sp1Machine"),
    ("SP1Clean/FormalModel/ShardMachine.lean", "trace_iff_executionPath"),
    ("SP1Clean/FormalModel/ShardMachine.lean", "executes_iff"),
    ("SP1Clean/Soundness/Shard/Machine.lean", "realizes"),
    ("SP1Clean/Soundness/Shard/Machine.lean", "statement_iff_of_realizes"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "activeCommitLocalShard"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsCommitBoundaries"),
    ...
    ("SP1CleanTest/Alignment/Core/HostCommitBoundary.lean", "continuationBanks"),
    ("SP1CleanTest/Alignment/Core/HostCommitBoundary.lean", "continuationTampering"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "cpuWordGrouping"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "queueCPUProjection"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "queueHostReplay"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "queueWriteNeedsAllocation"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "queueCPUHandoff"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "physicalQueueHistory"),
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "queueReplayPrepends"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "installedQueueEndpoints"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "missingQueueEndpoints"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "futureNodeConsumers"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "installedRecords"),
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "noncanonicalNodeLength"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "installedCursor"),
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "installedPermissions"),
    ...
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "registeredReceiverHandoff"),
    ...
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "installedMemoryProjection"),
    ...
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "physicalHandoff"),
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "duplicateAndForgedHandoff"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "unguardedStoreIntoRom"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "protectedRejectsStoreIntoRom"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "protectedPartialStoreBesideRom"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "protectedNonStores"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "permissionAddressWindow"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "protectedPaddingIdentity"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "activeHaltLocalShard"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "legacyHaltExitRange"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsForgedHalt"),
    ...
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "replayPrefixStates"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "replayStopsAfterHalt"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "replayOrdinaryPreservesHost"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "acceptsSameRegisterTouches"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "acceptsStateClockCarry"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "clockPhaseNeedsProfile"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsActiveRowsAfterHalt"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsUnauthenticatedFetch"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "acceptsReorderedPaddedSegment"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "acceptsEmptySegments"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "activeSyscallLocalShard"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsBrokenSyscallLedger"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "hintReturnNeedsHostBinding"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "acceptsDistantSourceEpochs"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsUnboundSource"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsInvalidPlatform"),
    ...
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "activeLocalShard"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsWrongEndpoints"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsWrongSource"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "checksUntouchedRom"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsBrokenInventory"),
    ("SP1CleanTest/Alignment/Core/LocalCore.lean", "rejectsWrongFinalValue"),
    ...
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "continuingShard"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "terminalShard"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "joinedShards"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "splitJoinedShards"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "polyFunPath"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "terminalIdentity"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "rejectsAfterHalt"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "rejectsPositiveTerminalSegment"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "rejectsForgedHost"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "rejectsForgedMemory"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "observableResults"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "replayJoinedShards"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "rejectsForgedEvent"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "ordinaryContinues"),
    ("SP1CleanTest/Alignment/Core/ExecutionPath.lean", "rejectsRunnableAfterHalt"),
    ...
    ("SP1CleanTest/Alignment/Core/HostCommitBoundary.lean", "emptyBanks"),
    ("SP1CleanTest/Alignment/Core/HostCommitBoundary.lean", "repeatedBanks"),
    ("SP1CleanTest/Alignment/Core/HostCommitBoundary.lean", "boundaryTampering"),
    ("SP1CleanTest/Alignment/Core/HostCommitBoundary.lean", "terminalClocks"),
    ("SP1CleanTest/Alignment/Core/HostCommitBoundary.lean", "interleavedBanks"),
    ...
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "supportedCalls"),
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "writeLedger"),
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "otherCallLedgers"),
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "rejectedReads"),
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "gatedReads"),
    ("SP1CleanTest/Alignment/Core/HostCall.lean", "rejectedAliases"),
    ...
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "sharedCalls"),
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "missingAndOrphanRows"),
    ("SP1CleanTest/Alignment/Core/HostHintReadPartition.lean", "duplicateHandlers"),
    ...
    ("SP1CleanTest/Alignment/Core/HostFootprint.lean", "byteCovers"),
    ("SP1CleanTest/Alignment/Core/HostFootprint.lean", "dispatchFootprints"),
    ("SP1CleanTest/Alignment/Core/HostFootprint.lean", "paddedWriteFootprints"),
    ("SP1CleanTest/Alignment/Core/HostFootprint.lean", "observedDependency"),
    ("SP1CleanTest/Alignment/Core/HostFootprint.lean", "failedWordsDoNotAuthenticateBytes"),
    ("SP1CleanTest/Alignment/Core/HostFootprint.lean", "writtenWordMeaning"),
    ...
    ("SP1Clean/Alignment/Chips/DecodedProgramProvider/Bridge.lean", "spec_committed"),
    ("SP1Clean/Alignment/Chips/DecodedProgramProvider/Bridge.lean", "constraints_committed"),
    ("SP1CleanTest/Alignment/Core/InstructionDecode.lean", "opcodeCoverage"),
    ("SP1CleanTest/Alignment/Core/InstructionDecode.lean", "literalEncodings"),
    ("SP1CleanTest/Alignment/Core/InstructionDecode.lean", "operandEdges"),
    ("SP1CleanTest/Alignment/Core/InstructionDecode.lean", "rejectedEncodings"),
    ("SP1CleanTest/Alignment/Core/InstructionDecode.lean", "hintAliases"),
    ("SP1CleanTest/Alignment/Core/InstructionDecode.lean", "sailHintPriority"),
    ("SP1CleanTest/Alignment/Core/InstructionDecode.lean", "checkedProgram"),
    ("SP1CleanTest/Alignment/Core/InstructionDecode.lean", "fixedProgramConstraints"),
    ...
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "constructedRamRows"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "constructedRegisterRows"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "rejectsUnrelatedKeys"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "rejectsInvalidBoundaryRows"),
    ...
    ("SP1CleanTest/Alignment/Audit/MixedMemoryRows.lean", "syscallKeepsMixedReadTimes"),
    ("SP1CleanTest/Alignment/Audit/MixedMemoryRows.lean", "syscallPcArmCrossesLimb"),
    ...
    ("SP1Clean/Alignment/Chips/DecodedProgramProvider/Bridge.lean", "program_interaction_payload"),
    ...
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "nativeVerifierEndpoints"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "rejectsForgedBoot"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "nativeBoundaryInventories"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "finalizersDeferMemoryGuarantees"),
    ...
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "emptyInventory"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "mixedInventory"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "rejectsMalformedInventories"),
    ...
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "constructedFinalRows"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "rejectsInvalidFinalRows"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "finalInventories"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "rejectsMalformedFinalInventories"),
    ("SP1CleanTest/Alignment/Core/MemoryBoundary.lean", "pairedMemoryBoundary"),
    ...
    ("SP1CleanTest/Alignment/Audit/NativeCompletenessNonVacuity.lean",
    ...
    ("SP1CleanTest/Alignment/Audit/JointNonVacuity.lean", "anchorStep"),
    ("SP1CleanTest/Alignment/Audit/ActiveNativeCompleteness.lean",
     "activeView_compiled_event_exists"),
    ("SP1CleanTest/Alignment/Audit/ActiveNativeCompleteness.lean", "activeExecution_semantic"),
    ("SP1CleanTest/Alignment/Audit/ActiveNativeCompleteness.lean",
     "activeTrace_boundedNativeRelation"),
    ("SP1CleanTest/Alignment/Audit/ActiveNativeCompleteness.lean", "activeTrace_bounded_roundTrip"),
]
