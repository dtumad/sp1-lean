...
#
# Scope is every released main source library: `SP1Clean/`, `ToClean/`, `ToMathlib/`, and `ToPolyFun/`.
...
if grep -rniE 'native_decide' SP1Clean ToClean ToMathlib ToPolyFun --include='*.lean' 2>/dev/null; then
