...
`SP1Clean` library, 922 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
- 999 released declarations are probed (922 main + 77 test: the 34 real-row satisfiability
